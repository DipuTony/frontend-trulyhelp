...
const AdminLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Donations", href: "/admin/donations", icon: "currency-dollar" },
    { name: "Volunteers", href: "/admin/volunteers", icon: "user-group" },
    { name: "Expenses", href: "/admin/expenses", icon: "clipboard-document-list" },
    { name: "Payment Verification", href: "/admin/payment-verification", icon: "check-circle" },
    { name: "Reports", href: "/admin/reports", icon: "document-chart-bar" },
